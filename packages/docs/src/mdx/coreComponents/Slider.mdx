...
export const DemoComponent = () => {
  ...
  const [rangeSliderValue, setRangeSliderValue] = useState([3, 7])
  return (
    <>
      <Slider
      ...
      <SliderField
        ...
        handleChange={setRangeSliderValue}
      />
    </>
  )
}
...
Slider with range, value contains an array with from and to number.
